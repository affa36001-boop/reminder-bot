...
HELP_TEXT = (
    ...
    "<b>Учёт лидов:</b>\n"
    "• 🔑 <b>Кодовые слова</b> — слова кампаний (Chegirma и др.)\n"
    "• 🎯 <b>Лиды</b> — карточки лидов с этапами воронки\n"
    "• 📊 <b>Отчёт</b> — сводка: пришло / ответили / созвон / купили\n\n"
    "Лиды ловятся автоматически из входящих личных сообщений.\n\n"
    "Команды: /list, /today, /week, /report, /leads, /codewords, /cancel, /help."
)
